...
#change "C:/laragon/www/medical-assistant-chatbot/intents.json" to your intents.json directory for the code to work
with open('C:/laragon/www/medical-assistant-chatbot/intents.json', 'r') as json_data:
    intents = json.load(json_data)

#we load the data to torch so it can use it
#change "C:/laragon/www/medical-assistant-chatbot/data.pth" to your data.pth directory for the code to work
FILE = "C:/laragon/www/medical-assistant-chatbot/data.pth"
...
def getBotInput(userInput):
    #this function returns the bot's response depending on the user's input
