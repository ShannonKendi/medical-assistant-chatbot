...
with open('C:/laragon/www/medical-assistant-chatbot/intents.json', 'r') as f:
    intents = json.load(f)
...
#change "C:/laragon/www/medical-assistant-chatbot/data.pth" to your directory for the code to work
